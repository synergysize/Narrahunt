...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(os.path.join(os.path.dirname(__file__), 'logs', 'matrix.log')),
...
class NarrativeMatrix:
    ...
    def __init__(self, config_path: str = None):
        ...
        self.config_path = config_path or os.path.join(
            os.path.dirname(__file__), 'config', 'narrative_matrix.json'
        )
        self.current_objective_path = os.path.join(
            os.path.dirname(__file__), 'results', 'current_objective.txt'
        )
        self.narratives_dir = os.path.join(
            os.path.dirname(__file__), 'results', 'narratives'
        )
    ...
    def generate_objective(self) -> str:
        ...
        if not all_entities or not self.config["artifact_types"]:
            raise ValueError("Cannot generate objective: No entities or artifact types available")
        ...
        while attempts < max_attempts:
            ...
            if objective not in self.generated_objectives:
                ...
                with open(self.current_objective_path, 'w') as f:
                    f.write(objective)
    ...
    def mark_objective_complete(self, status: str = "completed") -> None:
        ...
        archive_dir = os.path.join(os.path.dirname(__file__), 'results', 'completed_objectives')
